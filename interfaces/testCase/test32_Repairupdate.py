...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Repairupdate")
...
class Repairupdate(unittest.TestCase):
    ...
    def test01_Repairupdate(self):

        #依賴其他接口
        get_xls_Addrepair = commons.get_xls("caseforparame.xlsx", "Addrepaircancel")
        try:
        ...
        # set url
        self.url = commons.get_url_from_xml('Repairupdate')
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repairupdate', self.info, self.case_name)
