...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Getbuildings")
...
class BuildingsList(unittest.TestCase):
    ...
    def test01_Getbuildings(self):
        # set url
        self._testMethodDoc = self.case_name
        self.url = commons.get_url_from_xml('Getbuildings')
    ...
    #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Getbuildings', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
    #
    #     # if self.result == '1':
