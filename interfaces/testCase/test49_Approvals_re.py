...
info = {}
Authorization_id = commons.get_Authorization("test87","123456","Authorizationid_approvals")
...
class Approvalre(unittest.TestCase):
    ...
    def test01_Approvalre(self):
        ...
        xls_reponses = commons.Deposit_xls_relyon("caseforparame.xlsx","Approvalre","Repairreapply",self.case_name)
        xls_reponse = json.loads(xls_reponses)
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Approvalre', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
