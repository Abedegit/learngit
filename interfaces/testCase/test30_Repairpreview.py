...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Repairpreview")
...
class Repairpreview(unittest.TestCase):
    ...
    def test01_Repairpreview(self):
        ...
        # set url
        self.url = commons.get_url_from_xml('Repairpreview')
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repairpreview', self.info, self.case_name)
