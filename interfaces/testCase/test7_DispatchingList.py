...
class Getdispatching(unittest.TestCase):
    ...
    def test01_Getdispatching(self):
        # set url
        self._testMethodDoc = self.case_name
        self.url = commons.get_url_from_xml('Getdispatching')
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Getdispatching', self.info, self.case_name)
