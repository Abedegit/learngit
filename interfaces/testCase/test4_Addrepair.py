...
Addrepair_xls = commons.get_xls("caseforparame.xlsx", "Addrepair")
...
class Addrepair(unittest.TestCase):
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Addrepair', self.info, self.case_name)
