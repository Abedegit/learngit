...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Apprp")
...
class Approvalre(unittest.TestCase):
    ...
    def test01_Approvalre(self):
        ...
        # xls_reponses = commons.Deposit_xls_relyon("caseforparame.xlsx","Apprp","Addrp",self.case_name)
        # xls_reponse = json.loads(xls_reponses)

        # set url
        self._testMethodDoc = self.case_name
        self.url = commons.get_url_from_xml('Apprp')
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Apprp', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
