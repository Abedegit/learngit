...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Repairsdetails")
...
class Repairsdetails(unittest.TestCase):
    ...
    def test01_Repairsdetails(self):
        ...
        xls_reponses = commons.Deposit_xls_relyon("caseforparame.xlsx", "Repairsdetails", "Addrepair", self.case_name)
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repairsdetails', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
    #
    #     # if self.result == '1':
