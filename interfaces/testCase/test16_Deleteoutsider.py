...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Deleteoutsider")
...
class Deleteoutsider(unittest.TestCase):
    ...
    def test01_Deleteoutsider(self):
        ...
        self.url = commons.get_url_from_xml('Deleteoutsider')
    ...
    #     self.assertEqual(self.info['code'], self.code)
    #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Deleteoutsider', self.info, self.case_name)
