...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Dispatchingdetails")
...
class Dispatchingdetails(unittest.TestCase):
    ...
    def test01_Dispatchingdetails(self):
        ...
        self.url = commons.get_url_from_xml('Dispatchingdetails')
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Dispatchingdetails', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
    #
    #     # if self.result == '1':
