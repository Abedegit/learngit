...
class Groupsedit(unittest.TestCase):
    def setParameters(self,case_name,id, areaId, cnName, enName, landCnName, landEnName, landId, itemId, isOutsider,key,
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Groupsedit', self.info, self.case_name)
