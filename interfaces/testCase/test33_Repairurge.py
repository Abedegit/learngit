...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Repairurge")
...
class Repairurge(unittest.TestCase):
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repairurge', self.info, self.case_name)
