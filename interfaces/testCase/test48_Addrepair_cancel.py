...
Addrepair_xls = commons.get_xls("caseforparame.xlsx", "Addrepaircancel")
...
class Addrepaircancel(unittest.TestCase):
    ...
    def test01_Addrepaircancel(self):
        ...
        self.url = commons.get_url_from_xml('Addrepaircancel')
        ...
        data = {
            "addr": self.addr,
            "attachmentIds": [self.attachmentIds,self.attachmentIds,self.attachmentIds],
            "id": self.id_change,
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Addrepaircancel', self.info, self.case_name)
