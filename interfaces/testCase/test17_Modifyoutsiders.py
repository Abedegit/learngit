...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Modifyoutsiders")
...
class Modifyoutsiders(unittest.TestCase):
    def setParameters(self,case_name,id, attachmentId,cnName,employeeId,enName,isReleased,tel,result,response):
    ...
    def test01_Modifyoutsiders(self):
        ...
        self.url = commons.get_url_from_xml('Modifyoutsiders')
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Modifyoutsiders', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
    #
    #     # if self.result == '1':
