...
class Repaircomplete(unittest.TestCase):
    def setParameters(self,case_name,id,serviceEvaluation,serviceScore,result,response):
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repaircomplete', self.info, self.case_name)
