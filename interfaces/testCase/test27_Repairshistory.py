...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Repairshistory")
...
class Repairshistory(unittest.TestCase):
    ...
    def test01_Repairshistory(self):
        ...
        # set url
        self.url = commons.get_url_from_xml('Repairshistory')
        self.url_new = self.url.split("/")
        self.id_change = commons.get_parameter_from_xls(xls_reponses_Addrepair,'id',None)
        self.url_last = "/"+self.url_new[1]+"/"+str(self.id_change)+"/"+self.url_new[2] + "?" + "isRepair=" +self.isRepair
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repairshistory', self.info, self.case_name)
