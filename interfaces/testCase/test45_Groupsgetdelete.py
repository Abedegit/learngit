...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Groupsgetdelete")
...
class Groupsgetdelete(unittest.TestCase):
    def setParameters(self,case_name,id,result,response,relyon_response):
    ...
    def test01_Groupsgetdelete(self):
        ...
        xls_reponses = commons.Deposit_xls_relyon("caseforparame.xlsx", "Groupsgetdelete", "AddGroups", self.case_name)
    ...
    def tearDown(self):
        ...
        print("测试结束，输出log完结\n\n")
        commons.delete_Authorization_id()
