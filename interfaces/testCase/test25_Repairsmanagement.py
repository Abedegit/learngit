...
class Repairsmanagement(unittest.TestCase):
    def setParameters(self,case_name,endDate,keywords,keywordsType,lang ,maxPageItems,offsetStart,startDate,result,response):
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repairsmanagement', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
    #
    #     # if self.result == '1':
