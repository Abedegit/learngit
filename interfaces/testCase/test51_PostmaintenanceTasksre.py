...
create_house_xls = commons.get_xls("caseforparame.xlsx", "PostmaintenanceTasksre")
...
class PostmaintenanceTasksre(unittest.TestCase):
    ...
    def test01_PostmaintenanceTasksre(self):
        ...
        #依賴其他接口參數
        xls_reponses = commons.Deposit_xls_relyon("caseforparame.xlsx", "PostmaintenanceTasksre", "Repairreapply", self.case_name)
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'PostmaintenanceTasksre', self.info, self.case_name)
