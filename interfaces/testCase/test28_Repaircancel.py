...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Repaircancel")
...
class Repaircancel(unittest.TestCase):
    ...
    def test01_Repaircancel(self):
        ...
        try:
            ...
            print("超出列表值")
        xls_reponses_Addrepairs = get_xls_Addrepair[1][-1]
        ...
        self.url = commons.get_url_from_xml('Repaircancel')
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repaircancel', self.info, self.case_name)
