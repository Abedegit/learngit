...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Itemslist")
...
class Itemslist(unittest.TestCase):
    def setParameters(self,case_name,keywords,lang,maxPageItems,offsetStart,released,roomTypeKey,result,response):
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Itemslist', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
    #
    #     # if self.result == '1':
