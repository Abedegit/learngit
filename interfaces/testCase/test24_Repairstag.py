...
create_house_xls = commons.get_xls("caseforparame.xlsx", "Repairstag")
...
class Repairstag(unittest.TestCase):
    ...
    def test01_Repairstag(self):

        # set url
        self._testMethodDoc = self.case_name
        self.url = commons.get_url_from_xml('Repairstag')
    ...
    def checkResult(self):
        ...
        #     print('第六步，記錄響應結果')
        commons.Deposit_xls('caseforparame.xlsx', 'Repairstag', self.info, self.case_name)
    #         # self.assertEqual(self.info['msg'], self.msg)
    #         # self.assertEqual(email, self.email)
    #
    #     # if self.result == '1':
